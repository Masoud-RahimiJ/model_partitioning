...
class Module:
    ...
    def __init__(self, must_be_loaded=False) -> None:
        """
        ...
        #Added
        super().__setattr__('must_be_loaded', must_be_loaded)
        super().__setattr__('is_loaded_lock', Semaphore(int(not must_be_loaded)))
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, strict,
        ...
        #Added
        is_all_parametrs_included = True
        for name, param in local_state.items():
            ...
            if key in state_dict:
                ...
                #Added
                is_all_parametrs_included = False
                if strict:
                    missing_keys.append(key)
        if is_all_parametrs_included and self.must_be_loaded:
            self.must_be_loaded = False
            self.is_loaded_lock.release()
