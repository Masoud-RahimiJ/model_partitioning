...
gpt_pytorch= [2.6,3.98,0.66,3.06,0.54]
gpt_md_pytorch= [2.6,9.50,2.16,3.96,0.73]
gpt_xl_pytorch= [2.6,37.1,9.12,8.2,1.17]
...
whisper_medium_tf= [7.1,5.6,4.61,3.96,22.7]
whisper_large_tf= [7.1,5.6,4.61,3.96,22.7]
