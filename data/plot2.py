...
data_pytorch_cpu = {
    ...
    "Vgg19" : [1.877, 1.745, 0.65, 0.2, 0.065],
    "Regent_y_128gf": [2,7.8,4.12,0.95,0.67],

    "Gpt2": [3.51, 3.27, 0.66, 0.18, 0.85],
    "Gpt2_medium": [3.49, 6.45, 2.18, 0.58, 2.2],
    "Gpt2_xl": [3.577, 22.66, 9.22, 2.1, 6.74],

    "Wav2vec_base": [3.65, 2.23, 0.56, 0.167, 0.52],
    "Whisper_medium": [3.57, 9.6, 4.5, 1, 9.05],
    "Whisper_large_v2": [3.57, 17.77, 8.88, 2.12, 16.87]
}

data_pytorch_gpu = {
    "Resnet50" : [2,0.47,0.14,1.4,0.61],
    "Vgg19" : [2,2.76,0.64,1.78,0.58],
    "Regent_y_128gf": [2,12.2,4.2,3.78,0.62],

    "Gpt2": [2.6,3.98,0.66,3.06,0.54],
    "Gpt2_medium": [2.6,9.50,2.16,3.96,0.73],
    "Gpt2_xl": [2.6,37.1,9.12,8.2,1.17],

    "Wav2vec_base": [2.6,2.35,0.56,2.05,0.64],
    "Whisper_medium": [2.6,16.13,4.52,4.56,2.47],
    "Whisper_large_v2": [2.6,30.7,8.93,7.22,3.09]
}

data_tf_cpu = {
    "Resnet50" : [2,0.47,0.14,0.1,0.05],
    "Vgg19" : [2.732, 0.483, 0.693, 0.45, 0.508],
    "Regent_y_040": [2,7.8,4.12,0.95,0.67],
...
data_tf_gpu = {
    "Resnet50" : [6.7,1.2,0.11,0.4,2.68],
    "Vgg19" : [6.7,0.3,0.62,1.1,1.7],
    "Regent_y_040": [7.2,0.64,4.5,2.07,5.2],

    "Gpt2": [7.1,0.56,0.63,0.9,4.6],
    "Gpt2_medium": [7.1,0.88,2.11,2.59,8.89],
    "Gpt2_xl": [7.1,0.84,9.23,10.9,17.3],

    "Wav2vec_base": [7.1,5.1,0.56,0.58,0.28],
    "Whisper_medium": [7.1,5.6,4.61,3.96,11.5],
    "Whisper_large_v2": [7.1,5.8,9.01,9.22,15.61]
}
